...
import com.example.sairamkrishna.intelimall.Constant;
import com.example.sairamkrishna.intelimall.Model_Class;
...
public class ItemsCustomeAdpater extends RecyclerView.Adapter<ItemsCustomeAdpater.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.item.setText(Constant.globalArraylist.get(position).getName());
